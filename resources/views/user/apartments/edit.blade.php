        ...
        <form action="{{ route('user.apartments.update', $apartment) }}" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="title" id="title" aria-describedby="helpId"
                    placeholder="" value="{{ $apartment->title }}">
            ...
            <div class="mb-3">
                ...
                <input type="number" min="1" step="1" class="form-control" name="beds" id="beds"
                    aria-describedby="helpId" placeholder="" value="{{ $apartment->beds }}">
                <small id="helpId" class="form-text text-muted">Help text</small>
            </div>
            {{-- square meters --}}
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="file" class="form-control" name="image" id="image" aria-describedby="helpId"
                    placeholder="">
                <small id="helpId" class="form-text text-muted">Help text</small>
                {{-- ! da mettere la preview dell'immagine già presente, se c'è --}}
            </div>
            {{-- full address --}}
            <div class="mb-3">
                <label for="full_address" class="form-label">Full address</label>
                <input type="text" class="form-control" name="full_address" id="full_address" aria-describedby="helpId"
                    placeholder="" value="{{ $apartment->full_address }}" />
                <small id="helpId" class="form-text text-muted">Help text</small>
            </div>
            {{-- visibility --}}
            <div class="form-check">
                <input class="form-check-input" type="checkbox" value="true" id="visibility"
